...
This article was inspired by the following problem,
which was posed and solved by Wacław Sierpiński\cite[Problem 209]{sierpinski1970}:
\begin{quote}
\emph{Prove that the sum of digits of the number $2^n$ 
...
This condition includes Sierpiński's problem as a special case.
...
16 becomes $1+6=7$, and 32 becomes $3+2=5$. The first few terms of this new sequence are listed below.
...
expect that the sum of the decimal digits of $2^n$ is asymptotic to $4.5 n \log_{10} 2$,
...
each containing at least one nonzero digit. 
